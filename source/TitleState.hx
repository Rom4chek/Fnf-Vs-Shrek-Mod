...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		{
			case 2:
				createCoolText(['RP Games']);
			// credTextShit.visible = true;
			case 3:
				addMoreText('JulianGaming');
			case 4:
				addMoreText('DedShot');		
			case 5:
				addMoreText('present');
			...
			case 6:
				deleteCoolText();
				createCoolText(['MryMaster']);
			// credTextShit.visible = false;
			// credTextShit.text = 'In association \nwith';
			// credTextShit.screenCenter();
			case 7:
				addMoreText('or Pelmen');
			case 8:
				addMoreText('or Dumpling');
			case 9:
				addMoreText('is cool');
			case 10:
				deleteCoolText();
			...
			case 16:
				addMoreText('Phamtom Arcade');
			case 17:
				addMoreText('kawaisprite and evilsk8er');
			case 18:
				deleteCoolText();
