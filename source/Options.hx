...
class Naughtyness extends Option
{
	...
	private override function updateDisplay():String
	{
		return  FlxG.save.data.naughtyness ? "Naughtyness ON" : "Naughtyness OFF";
	}
...
class SpecialNoteFlash extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.flashimposter = !FlxG.save.data.flashimposter;
		display = updateDisplay();
		return true;
	}
