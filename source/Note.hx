			...
			switch (PlayState.SONG.noteStyle)
			{
				...
				default:
						...
						switch(noteType)
						{
							...
							{
								frames = Paths.getSparrowAtlas('NOTE_assets');
								animation.addByPrefix('greenScroll', 'swamp up0');
								animation.addByPrefix('redScroll', 'swamp right0');
								animation.addByPrefix('blueScroll', 'swamp down0');
								animation.addByPrefix('purpleScroll', 'swamp left0');
							...
							case 3:
							{
								...
								animation.addByPrefix('redScroll', 'grey0');
								animation.addByPrefix('blueScroll', 'cyan0');
							...
							case 4:
								{
									frames = Paths.getSparrowAtlas('NOTE_assets');
									animation.addByPrefix('greenScroll', 'Medic up0');
									animation.addByPrefix('redScroll', 'medic right0');
									animation.addByPrefix('blueScroll', 'Medic down0');
									animation.addByPrefix('purpleScroll', 'medic left0');
							...
							default:
							{
								...
								animation.addByPrefix('purpleScroll', 'pruiple0');
